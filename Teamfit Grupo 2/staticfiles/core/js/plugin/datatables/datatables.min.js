...
!(function (t) {
    ...
    e._hungarianMap || r(e),
      t.each(n, function (r) {
        (l = e._hungarianMap[r]) === a ||
          (!i && n[l] !== a) ||
          ("o" === l.charAt(0)
            ? (n[l] || (n[l] = {}), t.extend(!0, n[l], n[r]), o(e[l], n[l], i))
            : (n[l] = n[r]));
      });
  }
  function i(t) {
    ...
    !t.sEmptyTable &&
      ...
      Rt(t, t, "sZeroRecords", "sEmptyTable"),
      !t.sLoadingRecords &&
        n &&
  ...
  function m(t) {
    ...
    for (e = 0, n = f.length; e < n; e++)
      if (((s = f[e]), (c = []), !s.sType && s._sManualType))
  ...
  function v(e, n, r, o) {
    ...
    if (r) for (i = 0, e = r.length; i < e; i++) o(i, r[i]);
  }
  function D(e, n, r, o) {
    var i = e.aoData.length,
      l = t.extend(!0, {}, qt.models.oRow, { src: r ? "dom" : "data", idx: i });
  ...
  function w(e) {
    ...
    if (
      ...
      var r = function (e, n, o) {
        var i, l;
        if ("" !== o)
          for (var s = 0, u = (l = T(o)).length; s < u; s++) {
            if (((o = l[s].match(ce)), (i = l[s].match(fe)), o)) {
              ...
              e =
                "" === (e = o[0].substring(1, o[0].length - 1)) ? i : i.join(e);
              break;
            }
  ...
  function L(t, e, n, r) {
    ...
    if ("dom" !== n && ((n && "auto" !== n) || "dom" !== i.src)) {
      ...
      if (s)
        if (r !== a) l(s[r], r);
        else for (n = 0, o = s.length; n < o; n++) l(s[n], n);
        ...
        (r !== a && r !== f) ||
          ...
          l && l._bAttrSrc
            ? (x(l.mData._)(o, s),
              ...
              p(l.mData.filter, e))
            : h
            ? (l._setter || (l._setter = x(l.mData)), l._setter(o, s))
            : (o[f] = s)),
          f++;
      };
    if (c)
    ...
    if (null === f.nTr) {
      for (
        ...
        (s = e.aoColumns[u]),
          ...
          s.fnCreatedCell &&
            s.fnCreatedCell.call(e.oInstance, l, _(e, a, u), d, a, u);
  ...
  function N(e, n, r) {
    ...
    if (n) {
      for (r === a && (r = !1), o = 0, i = n.length; o < i; o++) {
        for (u[o] = n[o].slice(), u[o].nTr = n[o].nTr, l = f - 1; 0 <= l; l--)
      ...
      for (o = 0, i = u.length; o < i; o++) {
        ...
        for (l = 0, n = u[o].length; l < n; l++)
          if (((s = f = 1), c[o][l] === a)) {
            for (
              e.appendChild(u[o][l].cell), c[o][l] = 1;
              u[o + f] !== a && u[o][l].cell == u[o + f][l].cell;
  ...
  function k(e) {
    ...
    if (-1 !== t.inArray(!1, n)) ft(e, !1);
      ...
      (e.bDrawing = !0),
        s !== a &&
          -1 !== s &&
          ((e._iDisplayStart = u ? s : s >= e.fnRecordsDisplay() ? 0 : s),
      ...
      if (0 !== c.length)
        for (l = u ? e.aoData.length : f, u = u ? 0 : s; u < l; u++) {
          var d = c[u],
            h = e.aoData[d];
          if ((null === h.nTr && P(e, d), (d = h.nTr), 0 !== i)) {
            var p = o[r % i];
            h._sRowStripe != p &&
              (t(d).removeClass(h._sRowStripe).addClass(p),
              (h._sRowStripe = p));
          }
          Nt(e, "aoRowCallback", null, [d, h._aData, r, u]), n.push(d), r++;
        }
      else
        (r = l.sZeroRecords),
          1 == e.iDraw && "ajax" == Mt(e)
            ? (r = l.sLoadingRecords)
            : l.sEmptyTable && 0 === e.fnRecordsTotal() && (r = l.sEmptyTable),
  ...
  function q(e) {
    var a = e.oClasses,
      ...
      c =
        ...
        (s =
          null !== e.searchDelay ? e.searchDelay : "ssp" === Mt(e) ? 400 : 0),
        t("input", a)
          .val(i.sSearch)
          .attr("placeholder", o.sSearchPlaceholder)
          .on("keyup.DT search.DT input.DT paste.DT cut.DT", s ? be(l, s) : l)
  ...
  function $(e) {
    for (
      var n, a, r = qt.ext.search, o = e.aiDisplay, i = 0, l = r.length;
      i < l;
      i++
    ) {
  ...
  function Y(t, e, n, a, r, o) {
    ...
    if ((0 !== qt.ext.search.length && (n = !0), (i = K(t)), 0 >= e.length))
      ...
      for (
        (i || n || o.length > e.length || 0 !== e.indexOf(o) || t.bSorted) &&
          (t.aiDisplay = l.slice()),
          e = t.aiDisplay,
          n = 0;
        n < e.length;
      ...
      if (((s = t.aoData[n]), !s._aFilterData)) {
        for (i = [], a = 0, o = u.length; a < o; a++)
          (e = u[a]),
            ...
            l.indexOf &&
              -1 !== l.indexOf("&") &&
              ((he.innerHTML = l), (l = pe ? he.textContent : he.innerText)),
  ...
  function rt(t) {
    ...
    if (t.bInitialised) {
      for (
        ...
        (a = o[e]), a.sWidth && (a.nTh.style.width = vt(a.sWidth));
      Nt(t, null, "preInit", [t]),
        O(t),
        ("ssp" != (o = Mt(t)) || i) &&
          ("ajax" == o
            ? B(t, [], function (n) {
                ...
                (t.iInitDisplayStart = r), O(t), ft(t, !1), ot(t, n);
              })
            : (ft(t, !1), ot(t)));
    } else
      setTimeout(function () {
  ...
  function it(t, e) {
    var n = parseInt(e, 10);
    (t._iDisplayLength = n), kt(t), Nt(t, null, "length", [t, n]);
  }
  function lt(e) {
    for (
      var n = e.oClasses,
    ...
    return (
      ...
      u
        .children()
        .append(e.oLanguage.sLengthMenu.replace("_MENU_", i[0].outerHTML)),
      t("select", u)
  ...
  function st(e) {
    var n = e.sPaginationType,
      ...
      i =
        ((n = t("<div/>").addClass(e.oClasses.sPaging + n)[0]), e.aanFeatures);
    return (
      r || a.fnInit(e, n, o),
      i.p ||
          ...
          fn: function (t) {
            if (r) {
              var e,
                ...
                u =
                  ((n = (u = -1 === l) ? 0 : Math.ceil(n / l)),
                  (l = u ? 1 : Math.ceil(s / l)),
                  (s = a(n, l)),
                  0);
              for (e = i.p.length; u < e; u++)
                Ot(t, "pageButton")(t, i.p[u], u, s, n, l);
            } else a.fnUpdate(t, o);
          },
          sName: "pagination",
        })),
    ...
    (r = m.scrollHeight > m.clientHeight),
      e.scrollBarVis !== r && e.scrollBarVis !== a
        ...
        : ((e.scrollBarVis = r),
          ...
          I &&
            ((o = I.clone().prependTo(T)),
            (n = I.find("tr")),
            (o = o.find("tr"))),
          (i = C.clone().prependTo(T)),
          (C = C.find("tr")),
          (r = i.find("tr")),
          ...
          "" === s
            ? ((x.width = "100%"),
              F &&
                (T.find("tbody").height() > m.offsetHeight ||
                  "scroll" == v.css("overflow-y")) &&
                (x.width = vt(T.outerWidth() - f)),
              (d = T.outerWidth()))
            : "" !== u && ((x.width = vt(u)), (d = T.outerWidth())),
          pt(N, r),
          pt(function (e) {
          ...
          (b.width = vt(s)),
          (u = T.height() > m.clientHeight || "scroll" == v.css("overflow-y")),
          (b[(c = "padding" + (A.bScrollbarLeft ? "Left" : "Right"))] = u
            ? f + "px"
            : "0px"),
          I &&
  ...
  function gt(n) {
    var a,
      ...
      y = D.bScrollOversize;
    for (
      (a = o.style.width) && -1 !== a.indexOf("%") && (g = a), a = 0;
      a < f.length;
      a++
    )
      (r = i[f[a]]),
        null !== r.sWidth && ((r.sWidth = bt(r.sWidthOrig, m)), (v = !0));
    if (y || (!v && !s && !l && c == b(n) && c == d.length))
      for (a = 0; a < c; a++)
        (f = p(n, a)), null !== f && (i[f].sWidth = vt(d.eq(a).width()));
    else {
      ...
      for (
        t("[name]", c).removeAttr("name"),
          ...
          s && u
            ...
            ? (c.css("width", "auto"),
              c.removeAttr("width"),
              c.width() < m.clientWidth && g && c.width(m.clientWidth))
            : l
  ...
  function yt(t) {
    ...
    for (m(t), e = 0, n = (r = Dt(t)).length; e < n; e++)
      (a = r[e]), a.formatter && s++, xt(t, a.col);
      ...
      r && e.oFeatures.bSortMulti
        ? -1 !== (r = t.inArray(n, re(i, "0")))
          ? (null === (n = s(i[r], !0)) && 1 === i.length && (n = 0),
            null === n ? i.splice(r, 1) : ((i[r][1] = l[n]), (i[r]._idx = n)))
          : (i.push([n, l[0], 0]), (i[i.length - 1]._idx = 0))
        : i.length && i[0][0] == n
        ? ((n = s(i[0])), (i.length = 1), (i[0][1] = l[n]), (i[0]._idx = n))
    ...
    if (e.oFeatures.bStateSave && !e.bDestroying) {
      var n = {
        ...
        columns: t.map(e.aoColumns, function (t, n) {
          return { visible: t.bVisible, search: Q(e.aoPreSearchCols[n]) };
        }),
      };
    ...
    n = function (n) {
      if (n && n.time) {
        ...
        if (
          -1 === t.inArray(!1, s) &&
          !(
            (0 < (s = e.iStateDuration) && n.time < +new Date() - 1e3 * s) ||
  ...
  function Nt(e, n, a, r) {
    ...
    return (
      ...
      null !== a &&
        ((n = t.Event(a + ".dt")), t(e.nTable).trigger(n, r), o.push(n.result)),
      o
    );
  }
  function kt(t) {
  ...
  function Wt(t, e) {
    ...
    return (
      e <= n
        ...
        : (t >= e - 1 - a
            ? (n = ie(e - (n - 2), e))
            : ((n = ie(t - a + 2, t + a - 1)).push("ellipsis"), n.push(e - 1)),
  ...
  var Ut,
    ...
    qt = function (e) {
      (this.$ = function (t, e) {
        ...
        (this.fnAddData = function (e, n) {
          var r = this.api(!0),
            o =
              t.isArray(e) && (t.isArray(e[0]) || t.isPlainObject(e[0]))
                ? r.rows.add(e)
                : r.row.add(e);
        ...
        (this.fnUpdate = function (t, e, n, r, o) {
          var i = this.api(!0);
          return (
            n === a || null === n ? i.row(e).data(t) : i.cell(e, n).data(t),
      ...
      return (
        this.each(function () {
          ...
          if ("table" != this.nodeName.toLowerCase())
            ...
            (null !== p && "" !== p) ||
              (this.id = p = "DataTables_Table_" + qt.ext._unique++);
            ...
            (I.nTable = this),
              ...
              Ht(I, "aoStateSaveParams", g.fnStateSaveParams, "user"),
              Ht(I, "aoStateLoadParams", g.fnStateLoadParams, "user"),
              Ht(I, "aoStateLoaded", g.fnStateLoaded, "user"),
              Ht(I, "aoRowCallback", g.fnRowCallback, "user"),
              Ht(I, "aoRowCreatedCallback", g.fnCreatedRow, "user"),
              Ht(I, "aoHeaderCallback", g.fnHeaderCallback, "user"),
              Ht(I, "aoFooterCallback", g.fnFooterCallback, "user"),
              Ht(I, "aoInitComplete", g.fnInitComplete, "user"),
              Ht(I, "aoPreDrawCallback", g.fnPreDrawCallback, "user"),
              (I.rowIdFn = w(g.rowId)),
              u(I);
            var A = I.oClasses;
            ...
            t.extend(!0, F, g.oLanguage),
              ...
              null === g.asStripeClasses &&
                (I.asStripeClasses = [A.sStripeOdd, A.sStripeEven]);
            p = I.asStripeClasses;
            ...
            if (
              ...
              (p = []),
              0 !== (C = this.getElementsByTagName("thead")).length &&
                (W(I.aoHeader, C[0]), (p = E(I))),
              null === g.aoColumns)
            )
              for (C = [], b = 0, h = p.length; b < h; b++) C.push(null);
            else C = g.aoColumns;
            for (b = 0, h = C.length; b < h; b++) f(I, p ? p[b] : null);
            if (
              (v(I, g.aoColumnDefs, C, function (t, e) {
                d(I, t, e);
              }),
              L.length)
            ) {
            ...
            p = function () {
              ...
              if (
                (0 === n.length && (n = t("<thead/>").appendTo(_)),
                (I.nTHead = n[0]),
                ...
                0 === n.length || 0 === n.children().length
                  ...
                  : n.length > 0 &&
                    ((I.nTFoot = n[0]), W(I.aoFooter, I.nTFoot)),
                g.aaData)
              )
    ...
    ae = function (t, e, n) {
      return (
        !!Qt(t) ||
        ((Qt(t) || "string" == typeof t) && !!ne(t.replace(zt, ""), e, n)) ||
        null
      );
    },
    re = function (t, e, n) {
  ...
  (Vt = function (e, n) {
        ...
        (n = e),
          ...
          (e = n
            ? n.nTable && n.oApi
              ...
              ? n.settings().toArray()
              : ("string" == typeof n ? (o = t(n)) : n instanceof t && (o = n),
                o
                  ? o
                      .map(function () {
      ...
      iterator: function (t, e, n, r) {
        ...
        for (
          ...
          if ("table" === e) (o = n.call(g, h[i], i)), o !== a && d.push(o);
            ...
            (o = n.call(g, h[i], this[i], i)), o !== a && d.push(o);
          else if (
            "column" === e ||
            "column-rows" === e ||
            "row" === e ||
      ...
      function (e, n) {
        if (t.isArray(e))
          ...
          for (a = 0, r = l.length; a < r; a++) {
            ...
            u ||
              ((u = { name: o, val: {}, methodExt: [], propExt: [] }),
              s.push(u)),
    ...
    Xt("draw()", function (t) {
      return this.iterator("table", function (e) {
        "page" === t
          ? k(e)
          : ("string" == typeof t && (t = "full-hold" !== t), O(e, !1 === t));
      });
    }),
    Xt("page()", function (t) {
      return t === a
  ...
  var De = function (e, n, r, o, i) {
      ...
      for (
        u = typeof n,
          (n && "string" !== u && "function" !== u && n.length !== a) ||
            (n = [n]),
          u = 0,
          c = n.length;
        u < c;
    ...
    Ce = function (e, n) {
      ...
      a = e.aiDisplayMaster;
      var s = n.search;
      if (((r = n.order), (o = n.page), "ssp" == Mt(e)))
        return "removed" === s ? [] : ie(0, a.length);
      if ("current" == o)
      ...
      function (r) {
        ...
        return De(
          ...
          function (e) {
            ...
            if ((o || (o = Ce(r, i)), null !== n && -1 !== t.inArray(n, o)))
              return [n];
            ...
            if (((n = le(oe(r.aoData, o, "nTr"))), e.nodeName))
              return e._DT_RowIndex !== a
                ? [e._DT_RowIndex]
                : e._DT_CellIndex
                ? [e._DT_CellIndex.row]
      ...
      var n = this.iterator(
          ...
          function (t) {
            ...
            for (a = 0, r = e.length; a < r; a++)
              (n = e[a]),
                n.nodeName && "TR" === n.nodeName.toUpperCase()
                  ? o.push(y(t, n)[0])
                  : o.push(D(t, n));
            return o;
          },
    ...
    Xt("row().data()", function (t) {
      ...
      return t === a
        ? e.length && this.length
          ...
          : a
        : ((e[0].aoData[this[0]]._aData = t), L(e[0], this[0], "data"), this);
    }),
  ...
  Xt("columns()", function (e, n) {
        ...
        return De(
          ...
          function (e) {
            ...
            return e.nodeName && e._DT_CellIndex
              ...
              ? n
              : (n = t(e).closest("*[data-dt-column]")).length
              ? [n.data("dt-column")]
              : [];
          },
          a,
    ...
    Jt("columns().visible()", "column().visible()", function (e, n) {
      var r = this.iterator("column", function (n, r) {
        ...
        if (e !== a && u.bVisible !== e) {
          ...
          (u.bVisible = e), N(n, n.aoHeader), N(n, n.aoFooter), It(n);
        }
      });
      return (
        e !== a &&
                ...
                for (i = [], l = 0, s = g.length; l < s; l++)
                  for (o = g[l], u = 0; u < m; u++)
                    (c = { row: o, column: u }),
                      r
                        ? ((f = p[o]),
                          e(c, _(n, o, u), f.anCells ? f.anCells[u] : null) &&
                            i.push(c))
                        : i.push(c);
                return i;
              }
      ...
      return (
        ...
        this.iterator("table", function (a) {
          ...
          (a.bDestroying = !0),
            ...
            l != u.parentNode && (f.children("thead").detach(), f.append(u)),
            c &&
              l != c.parentNode &&
    ...
    (qt.defaults = {
      ...
      oLanguage: {
        ...
        sInfo: "Mostrando _END_ de _TOTAL_ datos",
        sInfoEmpty: "Mostrando 0 de 0 datos",
            ...
            b = function (n, a) {
              ...
              for (r = 0, i = a.length; r < i; r++)
                if (((S = a[r]), t.isArray(S)))
                  (f = t("<" + (S.DT_el || "div") + "/>").appendTo(n)), b(f, S);
                else {
                  switch (((u = null), (c = ""), S)) {
                    case "ellipsis":
        ...
        _: function (e, n, a, r) {
          t(e.nTable).on("order.dt.DT", function (t, o, i, l) {
            e === o &&
              ...
              n
                .removeClass(
                  a.sSortingClass + " " + r.sSortAsc + " " + r.sSortDesc
                )
                .addClass(
                  "asc" == l[t]
                    ? r.sSortAsc
            ...
            if (((p = n[o]), e.isArray(p))) w(t, p);
              ...
              switch (((u = c = ""), p)) {
                case "ellipsis":
                  ...
                  break;
                case "first":
                  (c = m.sFirst), (u = p + (0 < i ? "" : " disabled"));
                  break;
                case "previous":
                  (c = m.sPrevious), (u = p + (0 < i ? "" : " disabled"));
                  break;
                case "next":
                  (c = m.sNext), (u = p + (i < l - 1 ? "" : " disabled"));
                  break;
                case "last":
                  (c = m.sLast), (u = p + (i < l - 1 ? "" : " disabled"));
                  break;
                default:
                  (c = p + 1), (u = i === p ? "active" : "");
              }
